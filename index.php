...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <span class="brand-text font-weight-light">Mi sitio</span>
            </a>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                          <li class="nav-item">
                            <a href="./views/users/index.html" class="nav-link">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <p>Aqui estoy mi descripción de mi sitio</p>
                                    <p>Aqui estoy mi descripción de mi sitio fgdfgdf</p>
                                    <p>dfgkjghkdfg dfgjfhgkjd</p>
                                </div><!-- /.card-body -->
                            </div>
                        </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2022 <a href="#">Mi sitio</a>.</strong>
